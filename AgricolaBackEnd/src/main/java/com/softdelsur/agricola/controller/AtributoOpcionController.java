...
public class AtributoOpcionController {
	...
	public AtributoOpcionModel addAtributoOpcion(@RequestBody AtributoOpcionModel atributoOpcionModel) {
		...
		return atributoOpcionConverter
				.convertAtributoOpcionToAtributoOpcionModel(atributoOpcionService.addAtributoOpcion(
						atributoOpcionConverter.convertAtributoOpcionModelToAtributoOpcion(atributoOpcionModel)));
