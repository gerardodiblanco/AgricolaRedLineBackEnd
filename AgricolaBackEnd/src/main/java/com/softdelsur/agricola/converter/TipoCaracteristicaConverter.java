...
public class TipoCaracteristicaConverter {
	public TipoCaracteristica convertTipoCaracteristicaModelToTipoCaracteristica(TipoCaracteristicaModel tipoCaracteristicaModel){
	...
	public TipoCaracteristicaModel convertTipoCaracteristicaToTipoCaracteristicaModel(TipoCaracteristica tipoCaracteristica){
