...
public class AtributoConverter {
	...
	public AtributoConOpcionesModel convertAtributoToAtributoConOpcionesModel(Atributo atributo) {
		...
		if (opciones != null) {
			atributoConOpcionesModel
					.setOpciones(atributoOpcionConverter.convertListAtributoOpcionToListAtributoOpcionModel(opciones));
		}
	...
	public List<AtributoConOpcionesModel> convertListAtributoToListAtributoConOpcionesModel(
