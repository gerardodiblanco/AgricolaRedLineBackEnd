...
import com.softdelsur.agricola.service.impl.TratoServiceImpl;
...
public class OrdenTrabajoConverter {
	...
	// manejo unidad de trabajo
		...
		UnidadTrabajo unidadTrabajo = unidadTrabajoService.findUnidadTrabajoById(ordenTrabajoModel.getUnidadTrabajo().getId());
	...
	// UnidadTrabajoSubCuartelModel		
			for (UnidadTrabajoSubCuartelModel unidadTrabajoSubCuartelModel: ordenTrabajoModel.getUnidadTrabajo().getSubCuarteles()) {
				...
				UnidadTrabajoSubCuartel unidadTrabajoSubCuartel = unidadTrabajoSubCuartelService.findById(unidadTrabajoSubCuartelModel.getIdUnidadTrabajoSubCuartel());
				OrdenTrabajoUnidadTrabajoSubCuartel ordenTrabajoUnidadTrabajoSubCuartel = new OrdenTrabajoUnidadTrabajoSubCuartel(unidadTrabajoSubCuartelModel.isCheckbox(),unidadTrabajoSubCuartel);
				ordenTrabajoUnidadTrabajoSubCuartel.setUnidadTrabajoSubCuartel(unidadTrabajoSubCuartel);
				ordenTrabajoUnidadTrabajoSubCuartel = ordenTrabajoUnidadTrabajoSubCuartelService.addOrdenTrabajoUnidadTrabajoSubCuartelRepository(ordenTrabajoUnidadTrabajoSubCuartel);
			...
			for (UnidadTrabajoPersonalModel unidadTrabajoPersonalModel: ordenTrabajoModel.getUnidadTrabajo().getPersonaless()) {
				System.out.println("unidad trabajo personal model");
				UnidadTrabajoPersonal unidadTrabajoPersonal = unidadTrabajoPersonalService.findById(unidadTrabajoPersonalModel.getId());
				OrdenTrabajoUnidadTrabajoPersonal ordenTrabajoUnidadTrabajoPersonal = new OrdenTrabajoUnidadTrabajoPersonal(unidadTrabajoPersonalModel.isCheckbox(),unidadTrabajoPersonal);
				ordenTrabajo.getOrdenTrabajoUnidadTrabajoPersonalList().add(ordenTrabajoUnidadTrabajoPersonal);
			}
			
			// UnidadTrabajoDepositoModel		
			for (UnidadTrabajoDepositoModel unidadTrabajoDepositoModel: ordenTrabajoModel.getUnidadTrabajo().getDepositos()) {
				System.out.println("unidad trabajo deposito model");
				UnidadTrabajoDeposito unidadTrabajoDeposito = unidadTrabajoDepositoService.findById(unidadTrabajoDepositoModel.getId());
				OrdenTrabajoUnidadTrabajoDeposito ordenTrabajoUnidadTrabajoDeposito = new OrdenTrabajoUnidadTrabajoDeposito(unidadTrabajoDepositoModel.isCheckbox(),unidadTrabajoDeposito);
	...
	// eliminar tareas para volverlas a crear
		EstadoOrdenTrabajoTarea estadoOrdenTrabajoTareaCreado = estadoOrdenTrabajoTareaService.findByNombre(EntidadesBasicas.estadoOrdenTrabajoTareaCreado);
		
		List<OrdenTrabajoTarea> ordenTrabajoTareaList = ordenTrabajoTareaService.findOrdenTrabajoTareaByOrdenTrabajoAndEstado(ordenTrabajo, estadoOrdenTrabajoTareaCreado);
	...
	public OrdenTrabajoModel convertOrdenTrabajoModelToOrdenTrabajo(OrdenTrabajo ordenTrabajo) {
		...
		UnidadTrabajoModel unidadTrabajoModel = unidadTrabajoConverter.convertUnidadTrabajoToUnidadTrabajoModel(ordenTrabajo.getUnidadTrabajo());
		
// for por deposito personal y sub cuartel  -> checkbox = true si ordenTrabajoUnidadTrabajo = true
		
	// sub cuartel
		for (OrdenTrabajoUnidadTrabajoSubCuartel ordenTrabajoUnidadTrabajoSubCuartel: ordenTrabajo.getOrdenTrabajoUnidadTrabajoSubCuartelList()) {
			for (UnidadTrabajoSubCuartelModel unidadTrabajoSubCuartelModel:unidadTrabajoModel.getSubCuarteles()) {
				if (ordenTrabajoUnidadTrabajoSubCuartel.getUnidadTrabajoSubCuartel().getId().equals(unidadTrabajoSubCuartelModel.getIdUnidadTrabajoSubCuartel())) {
					unidadTrabajoSubCuartelModel.setCheckbox(ordenTrabajoUnidadTrabajoSubCuartel.isSeleccion());
				}
			}
		}
	// deposito
		for (OrdenTrabajoUnidadTrabajoDeposito ordenTrabajoUnidadTrabajoDeposito: ordenTrabajo.getOrdenTrabajoUnidadTrabajoDepositoList()) {
			for (UnidadTrabajoDepositoModel unidadTrabajoDepositoModel:unidadTrabajoModel.getDepositos()) {
				if (ordenTrabajoUnidadTrabajoDeposito.getUnidadTrabajoDeposito().getId().equals(unidadTrabajoDepositoModel.getId())) {
		...
		// personal
		for (OrdenTrabajoUnidadTrabajoPersonal ordenTrabajoUnidadTrabajoPersonal: ordenTrabajo.getOrdenTrabajoUnidadTrabajoPersonalList()) {
			for (UnidadTrabajoPersonalModel unidadTrabajoPersonalModel:unidadTrabajoModel.getPersonaless()) {
				if (ordenTrabajoUnidadTrabajoPersonal.getUnidadTrabajoPersonal().getId().equals(unidadTrabajoPersonalModel.getId())) {
...
// tareas
		EstadoOrdenTrabajoTarea estadoOrdenTrabajoTarea = estadoOrdenTrabajoTareaService.findByNombre(EntidadesBasicas.estadoOrdenTrabajoTareaCreado);
		
		List<OrdenTrabajoTarea> ordenTrabajoTareaList = ordenTrabajoTareaService.findOrdenTrabajoTareaByOrdenTrabajoAndEstado(ordenTrabajo, estadoOrdenTrabajoTarea);
		...
		for (OrdenTrabajoTarea ordenTrabajoTarea: ordenTrabajoTareaList) {
			...
			for (MaquinariaModel maquinariaModel:tareaModel.getMaquinarias()) {
				for (OrdenTrabajoTareaMaquinaria ordenTrabajoTareaMaquinaria: ordenTrabajoTarea.getOrdenTrabajoTareaMaquinariaList()) {
			...
			for (InsumoModel insumoModel:tareaModel.getInsumos()) {
				for (OrdenTrabajoTareaInsumo ordenTrabajoTareaInsumo: ordenTrabajoTarea.getOrdenTrabajoTareaInsumoList()) {
