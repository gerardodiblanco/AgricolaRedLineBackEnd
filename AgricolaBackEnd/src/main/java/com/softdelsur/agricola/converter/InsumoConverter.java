...
public class InsumoConverter {
	...
	public Insumo convertInsumoModelToInsumo(InsumoModel insumoModel) {
		...
		/*
		 * UnidadMedida unidadMedida = null; unidadMedida = new UnidadMedida();
		 * unidadMedida.setNombreUM("kg");
		 * 
		 * insumo.setUnidadMedida(unidadMedidaConverter.
		 * convertUnidadMedidaModelToUnidadMedida(insumoModel.getUnidadMedida()));
		 */
		return insumo;
