...
public class CaracteristicaConverter {
	...
	public Caracteristica convertCaracteristicaModelToCaracteristica(CaracteristicaModel caracteristicaModel) {
		...
		caracteristica.setTipoCaracteristica(tipoCaracteristicaConverter
				.convertTipoCaracteristicaModelToTipoCaracteristica(caracteristicaModel.getTipoCaracteristica()));
	...
	public CaracteristicaModel convertCaracteristicaToCaracteristicaModel(Caracteristica caracteristica) {
		...
		caracteristicaModel.setTipoCaracteristica(tipoCaracteristicaConverter
				.convertTipoCaracteristicaToTipoCaracteristicaModel(caracteristica.getTipoCaracteristica()));
		return caracteristicaModel;
	}

	public List<Caracteristica> convertListCaracteristicaModelToListCaracteristica(
			List<CaracteristicaModel> caracteristicaModelList) {
	...
	public List<CaracteristicaModel> convertListCaracteristicaToListCaracteristicaModel(
			List<Caracteristica> caracteristicaList) {
